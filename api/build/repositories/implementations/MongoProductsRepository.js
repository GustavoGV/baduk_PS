...
var MongoProductsRepository = /** @class */ (function () {
    function MongoProductsRepository() {
    }
    MongoProductsRepository.prototype.findByName = function (email) {
    ...
    MongoProductsRepository.prototype.save = function (produto) {
        return __awaiter(this, void 0, void 0, function () {
            var mongoDoc;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MongoProductsRepository.prototype.findByPhone = function (phone) {
        return __awaiter(this, void 0, void 0, function () {
            var PhoneSearch;
            return __generator(this, function (_a) {
                switch (_a.label) {
